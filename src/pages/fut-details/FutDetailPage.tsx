            ...
            <div className="bg-primary-lighter rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{futState.fut?.type === 'mensal' ? 'Fut Mensal' : 'Fut Avulso'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Horário:</span>
                  <span className="text-white">{futState.fut?.time || 'Não definido'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Jogadores por time:</span>
                  <span className="text-white">{futState.fut?.playersPerTeam || 'Não definido'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Máximo de vagas:</span>
                  <span className="text-white">{futState.fut?.maxVagas || 'Não definido'}</span>
                </div>
              </div>
            </div>
          </div>
